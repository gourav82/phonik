...
const Contact = () => {
  ...
  return (
    ...
    <div className={`contact--details ${isMobile || isIpad ? "flex--direction-column":"flex flex--justify-content-between"}`}>
        ...
        <Link href={"/https://www.instagram.com/phonikindustries?utm_source=qr&igsh=MTZmZ2F1NzdrbG51eA=="}>  <li><FaInstagramSquare className='fs--35 bg--shadow  md--15 bg--radius pd--5' /></li></Link>
        <Link href={"/https://www.facebook.com/phonikindustries?mibextid=ZbWKwL"}> <li>< FaFacebook className='fs--35 bg--shadow  md--15 bg--radius pd--5' /></li></Link>
